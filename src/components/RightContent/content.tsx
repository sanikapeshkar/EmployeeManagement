    ...
    <>
      <div className={styles.Content}>
        {displayedData.map((each, i) => {
            ...
            <div className={styles.Main}>
              <div className={styles.Information}>
                <div key={i}>
                  ...
                  <h3>
                    Address:{each.address.city} {each.address.street}
                  </h3>
                </div>
                <div> </div>
          ...
          <button className={styles.Delete} onClick={()=>props.handleDelete(each.id)}>Delete</button>
        </div>
              </div>
              <div className={styles.ButtonContainer}>
                <button onClick={() => props.handlePrevious(each.id)}>
                  Previous
                </button>
                <button onClick={() => props.handleNext(each.id)}>Next</button>
              </div>
            </div>
          );
        })}
